...
export default function SupplierTickets({ workspaceId, suppliers = [], canManage = false }) {
  ...
  const [draft, setDraft] = useState({ supplier_id: "", title: "", description: "", priority: "normaal", supplier_email: "", files: [] });
  ...
  async function createTicket(event) {
    ...
    setDraft({ supplier_id: "", title: "", description: "", priority: "normaal", supplier_email: "", files: [] }); setOpenForm(false); setMessageText("Leveranciersticket aangemaakt."); load();
  }
