...
export default function CentralEventCreator({ workspaceId, businessId, businesses, session }) {
  ...
  return <section className="panel" style={{ marginBottom: 24 }}>
    ...
    <style jsx>{`
      ...
      @media(max-width:760px){.ticketVariationGrid{grid-template-columns:1fr}.campaignCardMain{display:block}.campaignCardImage{margin-bottom:10px}.campaignCardImage img{width:100%;max-width:220px;height:120px}}
    `}</style>
  </section>;
}
