  ...
  return <section className="panel" style={{ marginBottom: 24 }}>
    ...
    <div className="eventCreatorGrid">
      ...
      <div className="imageUploads wide">
        <div className="imageUploadHead"><strong>Afbeeldingen per kanaal</strong><p>Sleep een afbeelding naar het juiste formaat of kies een bestand. Horeca OS gebruikt automatisch het beste beeld per kanaal.</p></div>
