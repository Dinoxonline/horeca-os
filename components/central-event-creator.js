          ...
          <div className="campaignCardMain">
            ...
            {selectedGroupTargets.length > 0 && (!isWebsiteEvent || campaignWorkflowStep >= 3) && <div className="facebookGroupShareActions">
              ...
              <div className={`facebookGroupActorGate ${facebookBrowserHelperReady ? "confirmed" : "blocked"}`}>
                <div><b>{facebookBrowserHelperReady ? `Facebookgroepen-helper ${facebookBrowserHelperVersion} is verbonden` : facebookBrowserHelperVersion ? `Facebookgroepen-helper ${facebookBrowserHelperVersion} is verouderd` : "Facebookgroepen-helper is nog niet actief"}</b><span>Versie 1.2.2 deelt het bestaande Facebook-evenement in de gekozen groep en wacht op jouw Enter-toets.</span></div>
                {!facebookBrowserHelperReady && <a href="/downloads/horeca-os-facebook-helper-1.2.2.zip" download>Helper 1.2.2 downloaden</a>}
