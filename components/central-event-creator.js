...
export default function CentralEventCreator({ workspaceId, businessId, businesses, session }) {
  ...
  async function saveIncompleteDraft() {
    ...
    try {
      ...
      const channel_payloads = {
        ...
        facebook: { text: form.facebookText.trim() || form.shortDescription.trim() || form.description.trim(), cta: common.cta, image_url: imageFor("landscape", ["square"]), placements: form.facebookPlacements, group_sharing: { mode: "manual", groups: [] } },
  ...
  async function createPromotionDraft(websiteEvent, calendarDelivery = null) {
    ...
    const channel_payloads = {
      ...
      facebook: { text: form.facebookText.trim() || form.shortDescription.trim(), cta: common.cta, image_url: imageFor("landscape", ["square"]), placements: form.facebookPlacements, group_sharing: { mode: "manual", groups: [] } },
