...
export default function CentralEventCreator({ workspaceId, businessId, businesses, session }) {
  ...
  return <section className="panel" style={{ marginBottom: 24 }}>
    ...
    {form.preparePromotion && <div className="channelDetails">
      ...
      {form.channels.facebook && <fieldset><legend>Facebook — klaarzetten voor publicatie</legend>
      ...
      {eventCampaigns.length === 0 ? <div className="emptyCampaignState">
        ...
        return <article key={item.id}>
          <div className="campaignCardMain">
            ...
            {selectedGroupTargets.length > 0 && <div className="facebookGroupShareActions">
    ...
    <style jsx>{`
      ...
      .facebookDestination{display:grid;gap:3px;padding:11px 12px;border-left:4px solid #1877f2;border-radius:8px;background:#eef5ff}.facebookDestination.ready strong{color:#145dbf}.facebookDestination.missing{border-left-color:#e4a91b;background:#fff2d1;color:#815b00}.facebookDestination span{font-size:13px}.channelActions,.channelPlanningActions{display:flex;flex-wrap:wrap;align-items:center;gap:6px}.channelPlanningActions input{width:190px;padding:6px 8px;font-size:11px}.channelManageLink{display:inline-flex;align-items:center;border:1px solid currentColor;border-radius:7px;padding:5px 7px;background:#fff;text-decoration:none}.cancelChannelButton{color:#a12f2f!important}.facebookGroupPicker{display:grid;gap:9px;padding:12px;border-radius:9px;background:#f5f8fa}.facebookGroupPicker p{margin:0}.facebookGroupPickerHead{display:flex;justify-content:space-between;gap:12px;align-items:center}.facebookGroupPickerHead span{padding:5px 8px;border-radius:999px;background:#e5efff;color:#145dbf;font-size:12px;font-weight:800}.facebookGroupTools{display:grid;grid-template-columns:minmax(220px,1fr) auto;align-items:end;gap:10px}.facebookGroupTools>div{display:flex;gap:7px}.facebookGroupTools button{border:1px solid #1877f2;border-radius:8px;padding:9px 11px;background:#fff;color:#145dbf;font-weight:800;cursor:pointer}.facebookGroupList{display:grid;gap:7px;max-height:330px;overflow:auto;padding:4px 8px 4px 2px;border-block:1px solid #d5e0e7}.facebookGroupChoice{display:flex;align-items:center;justify-content:space-between;gap:10px}.facebookGroupChoice button{border:0;background:none;color:#a12f2f;text-decoration:underline;cursor:pointer}.facebookGroupAdd{display:grid;grid-template-columns:1fr 1.4fr auto;gap:8px}.facebookGroupAdd button,.facebookGroupShareActions button{border:1px solid #1877f2;border-radius:8px;padding:9px 11px;background:#fff;color:#145dbf;font-weight:800;cursor:pointer}.facebookGroupShareActions{display:flex;flex-wrap:wrap;align-items:center;gap:7px;margin-top:10px;padding:10px;border-left:4px solid #1877f2;border-radius:8px;background:#eef5ff}.facebookGroupShareActions strong,.facebookGroupShareActions>p{flex-basis:100%;margin:0}.facebookGroupShareActions p{color:#405866;font-size:13px}.facebookGroupDelaySettings{display:grid;grid-template-columns:repeat(2,minmax(150px,220px));gap:8px;flex-basis:100%}.facebookGroupDelaySettings input{padding:7px 9px}.facebookGroupWait{padding:9px 11px;border-radius:8px;background:#fff2d1;color:#815b00!important}.facebookGroupComplete{padding:9px 11px;border-radius:8px;background:#e9f6ee;color:#236d46!important}.facebookGroupShareActions .facebookGroupReset{margin-left:auto;border-color:#78909c;color:#405866}
