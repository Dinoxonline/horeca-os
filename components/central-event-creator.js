            ...
            {isWebsiteEvent && (distribution.target_channels || []).includes("facebook") && <div className="facebookEventLinkActions">
              ...
              {facebookEventDelivery.status === "confirmed" && facebookEventDelivery.permalink
                ...
                : <div className="facebookEventManualWorkflow">
                  <p><b>Nog niet gekoppeld.</b> Klik eerst hierboven op <b>Facebook-evenement maken</b>. Facebook opent met de gegevens en afbeelding. Koppel daarna alleen de nieuwe Facebook-link terug aan dit dossier.</p>
