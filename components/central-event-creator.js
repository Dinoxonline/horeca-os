  ...
  return <section className="panel" style={{ marginBottom: 24 }}>
    ...
    {form.preparePromotion && <div className="channelDetails">
      ...
      {form.channels.facebook && <fieldset className="wide facebookChannelSection"><legend>Facebook — klaarzetten voor publicatie</legend>
        ...
        {isEvent && <div className="facebookDestination ready"><strong>Facebookbericht en Facebook-evenement zijn twee aparte stappen</strong><span>Na het opslaan kun je eerst het paginabericht plaatsen. Gebruik daarna bij het opgeslagen evenement de knop “Evenement op {facebookAccount?.display_name || "Facebook"} maken” om ook het echte Facebook-evenement met datum, tijd en locatie in de Facebook-agenda aan te maken en te bevestigen.</span></div>}
      ...
      {eventCampaigns.length === 0 ? <div className="emptyCampaignState">
        ...
        return <article key={item.id}>
          <div className="campaignCardMain">
            ...
            {editorialTargets.length > 0 && <div className="editorialSubmissionActions">
            ...
            {isWebsiteEvent && (distribution.target_channels || []).includes("facebook") && <div className="facebookEventLinkActions">
              ...
              {facebookEventDelivery.status === "confirmed" && facebookEventDelivery.permalink
                ...
                : <>
                  ...
                  <button type="button" disabled={conceptBusy || !facebookEventOrganizerChecks[item.id]} onClick={() => saveFacebookEventLink(item)}>Evenement koppelen</button>
                </>}
            </div>}
    ...
    <style jsx>{`
      ...
      .facebookEventLinkActions>.check{grid-column:1/-1}
