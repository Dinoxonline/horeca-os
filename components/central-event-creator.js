      ...
      {form.channels.facebook && <fieldset><legend>Facebook — klaarzetten voor publicatie</legend>
        ...
        <div className="facebookGroupPicker">
          ...
          {facebookGroups.length > 0 && <div className="facebookGroupTools">
            ...
            <div><button type="button" disabled={visibleFacebookGroups.length === 0} onClick={selectVisibleFacebookGroups}>Alles zichtbaar aanvinken</button><button type="button" disabled={selectedFacebookGroupIds.length === 0} onClick={() => setSelectedFacebookGroupIds([])}>Alles uitvinken</button></div>
          </div>}
