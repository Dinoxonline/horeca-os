  ...
  return (
    <>
      ...
      {canManage && <section className="panel" style={{ marginBottom: 14 }}>
        ...
        <div className="toolbar" style={{ justifyContent: "flex-start", alignItems: "center" }}><input readOnly value="https://horeca-os-le-club.vercel.app/medewerkers/cc-plein-medewerkers" style={{ flex: 1, minWidth: 280 }} /><button type="button" className="primary" onClick={() => navigator.clipboard?.writeText("https://horeca-os-le-club.vercel.app/medewerkers/cc-plein-medewerkers")}>Link kopiëren</button><a className="secondary" href="/werkbord/tickets">Tickets bekijken</a></div>
      </section>}
