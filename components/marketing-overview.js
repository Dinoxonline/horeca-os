...
export default function MarketingOverview({ workspaceId, businesses, session }) {
  ...
  async function linkExternalEvent(item, existingItem = null) {
  ...
  async function mergeManagedDuplicate(item, matchingItem) {
