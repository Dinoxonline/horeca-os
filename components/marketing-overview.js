...
const channelLabels = { website: "Website", facebook: "Facebook", instagram: "Instagram", google: "Google", predis: "Predis", other: "Overige" };
...
export function EventDetails({ workspaceId, session, onPredisSaved, onInstagramPublished, item, matchItem, sameDayItems = [], sourceComparisonItems = [], sourceComparisonCheck = "idle", business, onClose, onLink, onLinkExisting, onChooseMatch, onSyncContent, onUpdateWebsite, facebookLinkCheck, onConfirmFacebook, onCompareSources, comparing, linking, syncError, mergeNotice, contentSaveNotice }) {
  ...
  function closeDetails() { if (!predisUnsaved || window.confirm("Je Predis-voorbereiding is nog niet bewaard of wordt verwerkt. Wil je toch sluiten?")) onClose(); }
