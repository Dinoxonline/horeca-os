...
export function EventDetails({ item, matchItem, sameDayItems = [], sourceComparisonItems = [], business, onClose, onLink, onLinkExisting, onChooseMatch, onSyncContent, onUpdateWebsite, onConfirmFacebook, onCompareSources, comparing, linking, syncError }) {
