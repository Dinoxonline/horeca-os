...
export function sourceComparisonStatus(item, sources = [], check = "idle") {
  ...
  return !differences.length
    ...
    : { key: "different", title: "Verschillen gevonden", localTitle, differences,
