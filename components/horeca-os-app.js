...
function ReviewsInbox({ workspaceId, businessId, businesses, canManage, canAdd }) {
  const [reviews, setReviews] = useState([]); const [reviewMessage, setReviewMessage] = useState(""); const [statusFilter, setStatusFilter] = useState("all");
