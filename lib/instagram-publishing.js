export const INSTAGRAM_FORMATS = {
  feed: { label: "Feedbericht (foto)", hint: "Eén foto met bijschrift in je feed.", min: 1, max: 1 },
  carousel: { label: "Carrousel", hint: "2–10 foto's of video's in één feedbericht, in de gekozen volgorde.", min: 2, max: 10 },
  story: { label: "Story (verhaal)", hint: "Eén foto of video. Tekst moet al in het beeld staan; geen los bijschrift.", min: 1, max: 1 },
  reel: { label: "Reel (video)", hint: "Eén video met bijschrift. Bij voorkeur staand (9:16).", min: 1, max: 1 },
};
