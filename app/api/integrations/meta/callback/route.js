...
export async function GET(request) {
  ...
  try {
    ...
    longUrl.search = new URLSearchParams({ grant_type: "ig_exchange_token", client_secret: process.env.META_APP_SECRET || "", access_token: shortToken.access_token }).toString();
