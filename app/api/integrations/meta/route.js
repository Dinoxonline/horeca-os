...
import { createMetaState, getInstagramConfiguration } from "../../../../lib/meta-oauth";
...
export async function POST(request) {
  ...
  if (!configuration.ready) return jsonError(`De Instagram-koppeling mist serverinstellingen: ${configuration.missing.join(", ")}.`, 409);
