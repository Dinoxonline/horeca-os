...
begin
  for w in select id as workspace_id from public.workspaces loop
    ...
    values
      ...
      (w.workspace_id, 'grill_your_own', 'Grill Your Own', 'Campagne- en operatieproces voor het nieuwe concept.', 'marketing')
